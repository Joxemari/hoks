...
const DICT = {
  en: {
    ...
    'grammar.note': 'The fragment that decides the form — read from the same file that draws the work, so it cannot go stale. Not the whole code: … marks what is left out.',
  ...
  es: {
    ...
    'grammar.note': 'El fragmento que decide la forma — leído del mismo archivo que dibuja la obra, así que no puede quedarse viejo. No es todo el código: … marca lo que falta.',
  ...
  eu: {
    ...
    'grammar.note': 'Forma erabakitzen duen zatia — obra marrazten duen fitxategi beretik irakurria. Ez da kode osoa: … ikurrak falta dena markatzen du.',
