...
const DICT = {
  en: {
    ...
    'rule.title': 'The rule', 'family.generator': 'Generator — play with the system',
    'label.selected': 'Selected works — each a seed, one of one',
    'cartela.thisone': 'This one', 'cartela.seed': 'seed', 'cartela.format': 'format',
    'cartela.horizontal': 'Horizontal (DIN)', 'cartela.edition': 'edition', 'cartela.unique': '1/1 · unique print', 'cartela.year': 'year',
    'mof.k': 'Making of', 'mof.title': 'How {n} is built', 'mof.read': 'Read the essay →', 'mof.prep': 'In preparation',
    'mof.blurb': 'An illustrated essay — where the rule came from, every decision, and the published odds.',
    'mof.blurbPrep': 'The illustrated essay for this family is being written — the rule, the decisions, the published odds.',
    'mof.back': 'Back to', 'mof.essay': 'Making of · an illustrated essay',
  ...
  es: {
    ...
    'rule.title': 'La regla', 'family.generator': 'Generador — juega con el sistema',
    'label.selected': 'Obras seleccionadas — cada una una semilla, única',
    'cartela.thisone': 'Esta', 'cartela.seed': 'semilla', 'cartela.format': 'formato',
    'cartela.horizontal': 'Horizontal (DIN)', 'cartela.edition': 'edición', 'cartela.unique': '1/1 · impresión única', 'cartela.year': 'año',
    'mof.k': 'Cómo se hace', 'mof.title': 'Cómo se construye {n}', 'mof.read': 'Leer el ensayo →', 'mof.prep': 'En preparación',
    'mof.blurb': 'Un ensayo ilustrado — de dónde salió la regla, cada decisión y las probabilidades publicadas.',
    'mof.blurbPrep': 'El ensayo ilustrado de esta familia se está escribiendo — la regla, las decisiones, las probabilidades.',
    'mof.back': 'Volver a', 'mof.essay': 'Cómo se hace · un ensayo ilustrado',
  ...
  eu: {
    ...
    'rule.title': 'Araua', 'family.generator': 'Sortzailea — jolastu sistemarekin',
    'label.selected': 'Obra hautatuak — bakoitza hazi bat, bakarra',
    'cartela.thisone': 'Hau', 'cartela.seed': 'hazia', 'cartela.format': 'formatua',
    'cartela.horizontal': 'Horizontala (DIN)', 'cartela.edition': 'edizioa', 'cartela.unique': '1/1 · kopia bakarra', 'cartela.year': 'urtea',
    'mof.k': 'Nola egina', 'mof.title': 'Nola eraikitzen den {n}', 'mof.read': 'Irakurri saiakera →', 'mof.prep': 'Prestatzen',
    'mof.blurb': 'Saiakera ilustratu bat — araua nondik sortu zen, erabaki bakoitza eta argitaratutako probabilitateak.',
    'mof.blurbPrep': 'Familia honen saiakera ilustratua idazten ari da — araua, erabakiak, probabilitateak.',
    'mof.back': 'Itzuli', 'mof.essay': 'Nola egina · saiakera ilustratu bat',
    'next.family': 'Hurrengo familia',
    ...
    'about.fallback': 'code blacksmith gisa lan egiten dut, algoritmoak materian forjatuz.\n\nnire praktika ez da irudi finko batekin hasten, sistema batekin baizik: forma posible asko sortzeko gai diren arau, muga, probabilitate eta geometriekin.\n\nemaitza bat ez, prozesu bat errepikatzen duten produkzio-lerroak eraikitzen ditut. exekuzio bakoitzak aukera bat sortzen du. hautaketak erabakitzen du zein aukera eramango den aurrera eta materia bihurtuko den. ikusgai bihurtzen dena itzal bat besterik ez da: sistema baten pentsamenduak utzitako hondarra.\n\nkonputazioa fisiko bihurtzen denean, zehaztasunak eskalarekin, testurarekin, fabrikazioarekin eta denborarekin egiten du topo. ez dira gainditu beharreko mugak, obran parte hartzen duten indarrak baizik.\n\nkodeak proposatzen du. geometriak itzultzen du. materiak negoziatzen du.\n\nnon bizi da obra — artefaktuan, sisteman, ala bien arteko igarobidean?',
  },
};
