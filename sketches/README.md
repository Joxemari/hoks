...
`lrrg/` es el segundo caso, y llega de la misma manera: nace aquí. Fila única de
círculos con paso constante donde las ausencias hacen el ritmo. Pendiente de
alinear con las convenciones nuevas — nombre con G heredado de cuando el grano
justificaba familia aparte, harness propio en vez de `_lab.js`, y un formato
(dos A3 uno al lado del otro, 2√2:1) que no está en la tabla de arriba.
